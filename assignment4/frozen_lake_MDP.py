...
def forest_management_problem():
    # for grid_size in [10, 15, 20, 25]:
    for grid_size in [15, 20]:
        # Q-learning
        st = time.time()
        reward_array = []
        iter_array = []
        ...
        plt.grid()
        plt.title('Small Epsilon Grid Size: ' + str(grid_size) + 'Frozen Lake - Q Learning - Constant Epsilon')
        plt.ylabel('Average Reward')
        plt.savefig(' Small Epsilon Grid Size: ' + str(grid_size) + ' Frozen Lake - Q Learning - Constant Epsilon' + str('.png'))
        plt.clf()

        plt.plot([0.05, 0.15, 0.25], time_array)
        plt.xlabel('Epsilon Values')
        plt.grid()
        plt.title(' Small Epsilon Grid Size: ' + str(grid_size) + 'Frozen Lake - Q Learning')
        plt.ylabel('Execution Time (s)')
        plt.savefig(' Small Epsilon Grid Size: ' + str(grid_size) + ' Frozen Lake - Q Learning vs Time' + str('.png'))
        plt.clf()
        ...
        plt.imshow(Q_array[2])
        plt.colorbar()
        plt.savefig('Small Epsilon Grid Size: ' + str(grid_size) + ' Frozen Lake - Epsilon vs Q_array' + str('.png'))
        plt.clf()
