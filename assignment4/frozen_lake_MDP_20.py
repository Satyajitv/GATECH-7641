...
if __name__ == '__main__':
    ...
    for size in [25]:
        ...
        #All 15 size grid metrics
        """pol_time_array = [0.10942811965942383, 0.15942811965942383, 0.3629288673400879, 0.9835598468780518]
        pol_iters = [6, 7, 10, 11]
        pol_list_scores = [0.667, 0.698, 0.718, 0.658]

        time_array = [0.270626772380385741, 0.27216219902038574, 0.27549099922180176, 0.39495205879211426]
        iters = [20, 24, 37, 83]
        list_scores = [0.678, 0.68, 0.696, 0.698]
